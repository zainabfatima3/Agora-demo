 ...
 * @param height
 * @param fps
 * @returns [standard_bitrate, save_bitrate_ratio]
 */
...
export declare function interceptLocalAudioFrame(sender: RTCRtpSender, options?: InterceptLocalAudioFrameOptions): Promise<void>;
...
export declare function interceptRemoteAudioFrame(receiver: RTCRtpReceiver, options?: InterceptRemoteAudioFrameOptions): Promise<void>;
...
export declare class LocalVideoTrack extends LocalTrack implements ILocalVideoTrack {
    ...
    setEnabled(enabled: boolean, skipChangeState?: boolean): Promise<void>;
    setMuted(muted: boolean): Promise<void>;
    setSaveEncodeBitrateRatio(ratio?: number): Promise<void>;
    setEncoderConfiguration(config: VideoEncoderConfiguration | VideoEncoderConfigurationPreset, doNotRenegoation?: boolean): Promise<void>;
    getStats(): LocalVideoTrackStats;
    setBeautyEffect(enabled: boolean, options?: BeautyEffectOptions): Promise<void>;
    getCurrentFrameData(): ImageData;
...
declare class VideoPlayer {
    ...
    private _render_interframe_delays;
    private _render_interframe_delays_sizes;
    private _videoState;
