import { IAudioProcessor, IBaseProcessor, IExtension } from 'agora-rte-extension';
import * as react_jsx_runtime from 'react/jsx-runtime';
import { ReactNode, HTMLProps, PropsWithChildren } from 'react';
 ...
 * @public
 */
declare type AudioEncoderConfigurationPreset = keyof typeof AUDIO_ENCODER_CONFIG_SETTINGS;
 ...
 */
declare interface BeautyEffectOptions {
    /**
     *
 ...
 */
declare type CheckVideoVisibleResult$1 = CheckVisibleResult;
...
declare function event_content_inspect_connection_state_change(preState: InspectState$1, newState: InspectState$1): void;
...
declare function event_image_moderation_connection_state_change(newState: ImageModerationConnectionState$1, preState: ImageModerationConnectionState$1): void;
 ...
 * @event
 */
declare function event_video_element_visible_status(data?: CheckVideoVisibleResult$1): void;
 ...
 * @event
 */
declare function event_video_element_visible_status_2(data?: CheckVideoVisibleResult$1): void;
 ...
 */
declare interface IAgoraRTC extends EventEmitter {
    /**
 ...
 * @public
 */
declare interface IAgoraRTCClient extends EventEmitter {
    /**
 ...
 * @ignore
 */
declare interface IDataChannel extends EventEmitter {
    readonly id: number;
 ...
 */
declare interface IJoinOptions {
    /**
...
declare interface ILocalVideoTrack extends ILocalTrack {
     ...
     */
    getVideoElementVisibleStatus(): CheckVideoVisibleResult$1 | undefined;
    /**
 ...
 */
declare enum ImageModerationConnectionState$1 {
    /**
...
declare interface ImageTypedData {
    buffer: Uint8Array;
    width: number;
    height: number;
}
...
declare interface ITrack extends EventEmitter {
    /**
 ...
 */
declare interface MicrophoneAudioTrackInitConfig extends AudioTrackInitConfig {
    /**
     * The audio encoder configurations.
     *
     * You can set the audio encoder configurations in either of the following ways:
 ...
 */
declare type ScreenEncoderConfigurationPreset = keyof typeof SUPPORT_SCREEN_ENCODER_CONFIG_LIST;
 ...
 */
declare interface SVCConfiguration {
    /**
 ...
 *
 */
declare type SVCConfigurationPreset = keyof typeof SUPPORT_SVC_CONFIG_LIST;
 ...
 * > <sup>①</sup> `"720p_auto"` is only recommended to be set on Safari to ensure dynamic adjustment of the encoding resolution. For details, see the release notes.
 */
declare type VideoEncoderConfigurationPreset = keyof typeof SUPPORT_VIDEO_ENCODER_CONFIG_LIST;
 ...
 * @ignore
 */
declare enum VisibleHiddenReason$1 {
    COVERED = "COVERED",
    POSITION = "POSITION",
    SIZE = "SIZE",
    STYLE = "STYLE"
...
declare interface VisibleHiddenResult {
    visible: false;
    reason: keyof typeof VisibleHiddenReason$1;
}
 ...
 * > Agora recommends listening for this event and displaying the network quality.
 */
declare function useClientEvent(client: Nullable<IAgoraRTCClient>, event: "network-quality", listener: Nullable<(stats: NetworkQuality) => void>): void;
/**
 * Occurs when an error occurs in CDN live streaming.
 *
 * After the method call of {@link startLiveStreaming} succeeds, the SDK triggers this callback when errors occur during CDN live streaming.
 ...
 * - `LIVE_STREAMING_INVALID_RAW_STREAM`: Timeout for the CDN live streaming. Please check your media stream.
 */
declare function useClientEvent(client: Nullable<IAgoraRTCClient>, event: "live-streaming-error", listener: Nullable<(url: string, err: IAgoraRTCError) => void>): void;
/**
 * Occurs when a warning occurs in CDN live streaming.
 *
 * After the method call of {@link startLiveStreaming} succeeds, the SDK triggers this callback when warnings occur during CDN live streaming.
 ...
 * - `LIVE_STREAMING_WARN_FREQUENT_REQUEST`: Pushes stremas to the CDN too frequently.
 */
declare function useClientEvent(client: Nullable<IAgoraRTCClient>, event: "live-streaming-warning", listener: Nullable<(url: string, err: IAgoraRTCError) => void>): void;
/**
 * Reports exceptions in the channel.
 *
 * Exceptions are not errors, but usually reflect quality issues.
 ...
 * Occurs when the state of the connection between the SDK and the server changes.
 */
declare function useClientEvent(client: Nullable<IAgoraRTCClient>, event: "content-inspect-error", listener: Nullable<(error?: IAgoraRTCError) => void>): void;
/**
 * @ignore
 */
declare function useClientEvent(client: Nullable<IAgoraRTCClient>, event: "image-moderation-connection-state-change", listener: Nullable<(newState: ImageModerationConnectionState, preState: ImageModerationConnectionState) => void>): void;
/**
 * Callback for receiving the DataStream message.
 */
declare function useClientEvent(client: Nullable<IAgoraRTCClient>, event: "stream-message", listener: Nullable<(uid: UID, payload: Uint8Array) => void>): void;
/**
 * Occurs when a audio or video track ends.
 *
 * Reasons may include:
...
declare function AgoraRTCProvider({ client, children }: AgoraRTCProviderProps): react_jsx_runtime.JSX.Element;
/**
...
declare function AgoraRTCScreenShareProvider({ client, children, }: AgoraRTCScreenShareProviderProps): react_jsx_runtime.JSX.Element;
...
declare class AgoraRTCReactError extends Error implements IAgoraRTCReactError {
    ...
    readonly rtcError: IAgoraRTCError | string;
    readonly name: string;
    constructor(rtcMethod: string, rtcError: IAgoraRTCError | string);
    log(type: printType): void;
}
 ...
 * The last-mile network quality.
 */
interface NetworkQualityEx extends NetworkQuality {
    /**
 ...
 * ```
 */
declare function useNetworkQuality(client?: IAgoraRTCClient | null): NetworkQualityEx;
 ...
 * ```
 */
declare function useLocalMicrophoneTrack(ready?: boolean, audioTrackConfig?: MicrophoneAudioTrackInitConfig): {
 ...
 * ```
 */
declare function useLocalCameraTrack(ready?: boolean, cameraVideoTrackConfig?: CameraVideoTrackInitConfig): {
 ...
 * ```
 */
declare function useLocalScreenTrack(ready: boolean, screenVideoTrackInitConfig: ScreenVideoTrackInitConfig, withAudio: "enable"): {
    screenTrack: [ILocalVideoTrack, ILocalAudioTrack] | null;
    isLoading: boolean;
    error: AgoraRTCReactError | null;
};
declare function useLocalScreenTrack(ready: boolean, screenVideoTrackInitConfig: ScreenVideoTrackInitConfig, withAudio: "disable"): {
    screenTrack: ILocalVideoTrack | null;
    isLoading: boolean;
    error: AgoraRTCReactError | null;
};
declare function useLocalScreenTrack(ready: boolean, screenVideoTrackInitConfig: ScreenVideoTrackInitConfig, withAudio: "auto"): {
 ...
 * ```
 */
declare function LocalAudioTrack({ track: maybeTrack, play, volume, disabled, muted, children, }: LocalAudioTrackProps): react_jsx_runtime.JSX.Element | null;
 ...
 * ```
 */
declare function LocalVideoTrack({ track: maybeTrack, play, disabled, muted, style, videoPlayerConfig, ...props }: LocalVideoTrackProps): react_jsx_runtime.JSX.Element;
 ...
 * ```
 */
declare function LocalUser({ micOn, cameraOn, audioTrack, videoTrack, playAudio, playVideo, volume, cover, children, style, ...props }: LocalUserProps): react_jsx_runtime.JSX.Element;
 ...
 * ```
 */
declare function RemoteAudioTrack({ track, play, playbackDeviceId, volume, children, }: RemoteAudioTrackProps): react_jsx_runtime.JSX.Element | null;
 ...
 * ```
 */
declare function RemoteVideoTrack({ track, play, style, videoPlayerConfig, ...props }: RemoteVideoTrackProps): react_jsx_runtime.JSX.Element;
 ...
 * ```
 */
declare function RemoteUser({ user, playVideo, playAudio, playbackDeviceId, volume, cover, style, children, videoPlayerConfig, ...props }: RemoteUserProps): react_jsx_runtime.JSX.Element;
 ...
 * ```
 */
declare function TrackBoundary({ children }: PropsWithChildren): react_jsx_runtime.JSX.Element;
/**
 ...
 */
declare function useAutoPlayVideoTrack(track: Nullable<IRemoteVideoTrack | ILocalVideoTrack>, play?: boolean, videoPlayerConfig?: VideoPlayerConfig, div?: HTMLElement | null): void;
/**
...
export { AREAS, AgoraRTCErrorCode, AgoraRTCProvider, AgoraRTCReactError, AgoraRTCScreenShareProvider, type AgoraRTCScreenShareProviderProps, type AgoraRTCStats, AudienceLatencyLevelType, type AudioEncoderConfiguration, type AudioEncoderConfigurationPreset, type AudioSourceOptions, type AudioSourceState, type BeautyEffectOptions, type BufferSourceAudioTrackInitConfig, type CameraVideoTrackInitConfig, ChannelMediaRelayError, ChannelMediaRelayEvent, type ChannelMediaRelayInfo, ChannelMediaRelayState, type ClientConfig, type ClientRole, type ClientRoleOptions, ConnectionDisconnectedReason, type ConnectionState, type ConstrainLong, type CustomAudioTrackInitConfig, type CustomVideoTrackInitConfig, type DeviceInfo, type DeviceState, type ElectronDesktopCapturerSource, type EncryptionMode, type EventCustomReportParams, type FetchArgs, type IAgoraRTC, type IAgoraRTCClient, type IAgoraRTCError, type IAgoraRTCRemoteUser, type IBufferSourceAudioTrack, type ICameraVideoTrack, type IChannelMediaRelayConfiguration, type IDataChannel, type IDataChannelConfig, type IJoinOptions, type ILocalAudioTrack, type ILocalDataChannel, type ILocalTrack, type ILocalVideoTrack, type IMicrophoneAudioTrack, type IRemoteAudioTrack, type IRemoteDataChannel, type IRemoteTrack, type IRemoteVideoTrack, type ITrack, ImageModerationConnectionState, type ImageTypedData, type InspectConfiguration, type JoinOptions, type LiveStreamingTranscodingConfig, type LiveStreamingTranscodingImage, type LiveStreamingTranscodingUser, type LocalAccessPointConfig, LocalAudioTrack, type LocalAudioTrackProps, type LocalAudioTrackStats, LocalUser, type LocalUserProps, LocalVideoTrack, type LocalVideoTrackProps, type LocalVideoTrackStats, type LowStreamParameter, type MicrophoneAudioTrackInitConfig, type NetworkQuality, type NetworkQualityEx, RemoteAudioTrack, type RemoteAudioTrackProps, type RemoteAudioTrackStats, RemoteStreamFallbackType, RemoteStreamType, RemoteUser, type RemoteUserProps, RemoteVideoTrack, type RemoteVideoTrackProps, type RemoteVideoTrackStats, type SDK_AUDIO_CODEC, type SDK_CODEC, type SDK_MODE, type SVCConfiguration, type SVCConfigurationPreset, type ScreenEncoderConfigurationPreset, type ScreenSourceType, type ScreenVideoTrackInitConfig, TrackBoundary, type TurnServerConfig, type UID, VERSION, type VideoEncoderConfiguration, type VideoEncoderConfigurationPreset, type VideoPlayerConfig, VideoState, AgoraRTC as default, useAutoPlayAudioTrack, useAutoPlayVideoTrack, useClientEvent, useConnectionState, useCurrentUID, useIsConnected, useJoin, useLocalCameraTrack, useLocalMicrophoneTrack, useLocalScreenTrack, useNetworkQuality, usePublish, useRTCClient, useRTCScreenShareClient, useRemoteAudioTracks, useRemoteUserTrack, useRemoteUsers, useRemoteVideoTracks, useTrackEvent, useVolumeLevel };
